...
public class GrinderMultiblock extends IETemplateMultiblock {
    public GrinderMultiblock() {
        super(ResourceLocation.fromNamespaceAndPath(MODID, "multiblocks/grinder"), new BlockPos(1,0,0), new BlockPos(0,1,0), new BlockPos(3,5,4), TIContent.TIMultiblocks.GRINDER);
    }
