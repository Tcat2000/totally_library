...
public class MultiblockBuilder {
    ...
    public MultiblockBuilder(ResourceLocation id) {
        this.id = id;
    }

    public MultiblockBuilder logic(IMultiblockLogic<IMultiblockState> logic) {
        this.logic = logic;
        return this;
    }

    public MultiblockBuilder state(IMultiblockState state) {
        this.state = state;
        return this;
    }
