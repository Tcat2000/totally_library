...
import static net.minecraftforge.client.extensions.common.IClientFluidTypeExtensions.*;
...
//        consumer.putBulkData(matrixStack, new BakedQuad());
        ...
        IClientFluidTypeExtensions props = of(fluid);
        TextureAtlasSprite texture = Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).apply(props.getStillTexture());

        int color = of(fluid).getTintColor(fluid.defaultFluidState(), te.getLevel(), te.getBlockPos());
