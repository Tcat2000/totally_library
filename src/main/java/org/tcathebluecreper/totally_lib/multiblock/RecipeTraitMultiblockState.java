...
public class RecipeTraitMultiblockState extends TraitMultiblockState {
    public TLRecipeProcess<TLRecipe, TraitMultiblockState> process;

    public RecipeTraitMultiblockState(TraitHolder traits, Function<TraitMultiblockState, TLRecipeProcess<TLRecipe, TraitMultiblockState>> process) {
        super(traits);
        this.process = process.apply(this);
    }

    public RecipeTraitMultiblockState(IInitialMultiblockContext capSource, List<ITrait> traits, Function<TraitMultiblockState, TLRecipeProcess<TLRecipe, TraitMultiblockState>> process) {
