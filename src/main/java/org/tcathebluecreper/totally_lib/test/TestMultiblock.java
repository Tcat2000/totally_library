...
public class TestMultiblock {
    public static final RegisterableMultiblock testMB = new TLMultiblockBuilder(ResourceLocation.fromNamespaceAndPath("test","test"), TotallyLibrary.regManager, (mb) -> {}).bake();
}
